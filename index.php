  ...
  <link rel="stylesheet"  href="css/estilos.css">
   <script language="javascript">
    ...
    function validarNro(e) {
      ...
      function valida(f) {
        var ok = true;
        var msg = "Los siguientes datos son necesarios ingresarlos:\n";
        if(f.elements["TxtUsuario"].value == "")
        {
          msg += "° Ingrese Usuario\n";
          ok = false;
        }

        if(f.elements["TxtContra"].value == "")
        {
    ...
    <section class="todo">
      ...
      <br><br><br><br>
          <section id="cuerpo">
                   ...
                   <legend align="center">Bienvenido Administrador</legend>
