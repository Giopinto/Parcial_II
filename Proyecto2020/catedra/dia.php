        ...
        <div class="container-fluid">
          ...
          <table   width="98%">
            <tr>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;
              <td bgcolor="#B2D8BB" width="70%" align="left"><h3><b>Buscar Asistencia Dia Especifico</b></h3></td> 
              </td>
            </tr>          
          </table>
          <br>
              <form name="FormIm" method="post" action="dia1.php">
    
    <br><br>
    <table width="80%" align="center">
      <tr>
        <td >
          <h3><b>Seleccione fecha a buscar:</b></h3>
        </td> 
        <td>
          <h2>
