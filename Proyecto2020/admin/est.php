...
<html lang="es">
  ...
  <body onload="viewdata()">
    ...
    <div class="container">
 <br>
          <h2 align="center"><font color="#2969B0">Listado de Estudiantes</font></h2>
<!-- Button trigger modal -->

<p align="right"> 
<button type="button" class="btn btn-warning"> <a href="nestudiante.php">Nuevo Estudiante</a> </button> &nbsp;&nbsp;</p>
...
<div class="form-group">
    ...
    <input type="hidden" class="form-control" id="ad" value="<?php echo $_SESSION["usuario"]; ?>">
  </div>
  <!-- <div class="form-group">
    
   <input type="hidden" class="form-control" id="gd" value="<?php //echo $_SESSION["usuario"]; ?>">
  </div>
-->
</form>
...
<div id="info"></div>
  ...
  var datas="nm="+nm+"&ap="+ap+"&tel="+tel+"&c="+c+"&ad="+ad;
